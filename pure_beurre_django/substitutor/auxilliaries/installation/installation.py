...
class Installation:
    ...
    def insertions(self):
        ...
        if len(self.product_model.objects.all()) > 1:
            pass
        ...
        if len(self.store_model.objects.all()) > 1:
            pass
        ...
        if len(self.categorie_model.objects.all()) > 1:
            pass
        ...
        if len(self.product_model.objects.filter(store__isnull=False)) > 1:
            pass
        ...
        if len(self.product_model.objects.filter(categorie__isnull=False)) > 1:
            pass
